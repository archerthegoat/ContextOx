...
export const MOONSHOTAI_MODELS: ModelCatalog<MOONSHOTAI_MODELS_GROUPS, "moonshotai"> =
	flattenModelCatalog("moonshotai", values as MOONSHOTAI_MODELS_GROUPS);
