...
type QWEN_TOKEN_PLAN_MODELS_GROUPS = {
	"openai-completions": {
		"MiniMax-M2.5": object;
...
export const QWEN_TOKEN_PLAN_MODELS: ModelCatalog<QWEN_TOKEN_PLAN_MODELS_GROUPS, "qwen-token-plan"> =
	flattenModelCatalog("qwen-token-plan", values as QWEN_TOKEN_PLAN_MODELS_GROUPS);
