...
type HUGGINGFACE_MODELS_GROUPS = {
	"openai-completions": {
...
export const HUGGINGFACE_MODELS: ModelCatalog<HUGGINGFACE_MODELS_GROUPS, "huggingface"> =
	flattenModelCatalog("huggingface", values as HUGGINGFACE_MODELS_GROUPS);
